...
- **결과물:** **Biz 집사 (V1 Holdings) — 사업체 운영 텔레그램 봇** 실제 구현 완료 ✅
  ...
  **① 온보딩 & 문서 인텔리전스 (자료 흡수)**
  ...
  - 나는 PDF·이미지를 **텔레그램으로 전달**하면(예: 정관·주주명부 PDF), 봇이 텍스트로 추출(Tesseract 한글 OCR)해 법인 자료로 흡수한다. → 이후 모든 질문·일정 안내가 이 자료를 토대로 이뤄진다. (`005.jpg`)
...
- **링크 / 스크린샷:**
  ...
  **5) 문서 인텔리전스 — 정관·주주명부 PDF 흡수**

  ![문서 인텔리전스 - 정관·주주명부 PDF 흡수](이미지첨부/005.jpg)
