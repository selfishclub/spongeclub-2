...
export function renderShare(root, ctx) {
  root.appendChild(el('section', { class: 'view share' },
    ...
    el('div', { class: 'card' },
      el('h2', { text: '내 사례 올리기' }),
      el('p', { class: 'hint', text: '실천 전후의 변화를 아래 커뮤니티에 남겨주세요. (리워드 예정)' }),
      el('a', { class: 'primary link-btn', href: 'https://cafe.naver.com/f-e/cafes/30411340/menus/35?viewType=L', target: '_blank', rel: 'noopener noreferrer', text: '네이버 카페에 올리기' }),
      el('a', { class: 'primary link-btn', href: 'https://invite.kakao.com/tc/sXs6XD2KCr', target: '_blank', rel: 'noopener noreferrer', text: '카카오톡 단톡방 참여' }),
    ),
    el('div', { class: 'card' },
      el('h2', { text: '챌린지' }),
