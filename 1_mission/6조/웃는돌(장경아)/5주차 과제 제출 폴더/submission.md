...
- **어떻게 풀어볼 생각인지:**
  ...
  **③ 시간이 붙었을 때 무엇을 골랐나.** 4주차에 내가 직접 적어둔 문장이다:
  ...
  그리고 이 판정을 **한 번 더 뒤집어봤다.** 처음 검증할 때 나는 1주차 과제(`보고-포맷-변환`)와 4주차 과제(고고버디)를 흔적 OS의 증거로 섞어 쓰고 있었는데, **그 둘은 계보가 다른 별개 제품**이었다. 그래서 전부 빼고 다시 돌렸다.

  **판정은 안 바뀌었고, 근거 등급은 오히려 올라갔다** — 빠진 자리(1주차 인터뷰 = *말*)를 위 ①②③(= *행동*)이 채웠기 때문이다. 대신 그 위에 세웠던 결론 몇 개는 스스로 철회했다: *"역할을 가로지르는 패턴"*, 임원 보고 슬라이드로의 확장, 두 번째 타깃 사용자군. **증거를 빼고도 결론이 그대로면 의심해야 한다고 생각해서, 문서마다 "뺀 자리를 무엇이 채웠는지"를 명시했다.**
