...
summary: 흔적 OS는 3주차에 배포까지 끝냈는데 정작 내가 안 쓰게 됐다. 기능을 더 붙이려다 멈추고, "내가 이 제품을 위해 실제로 무엇을 고용하고 무엇을 해고했는가"를 기록으로 검증했다. 결과는 예상 밖이었다 — 제품 전체가 서 있던 전제(역할 전환 비용 제거)가 진짜 Job이 아니었다. 본캐를 바꾸고 PRD를 다시 쓴 뒤, 3주 걸릴 줄 알았던 개발을 하루에 배포했다. 그리고 배포 직전에, 내가 자랑스럽게 적어둔 "테스트 33개 통과"가 아무것도 보장하지 않았다는 걸 알게 됐다.
date: 2026-07-31
---
...
- **어떻게 풀어볼 생각인지:**
  ...
  **③ 시간이 붙었을 때 무엇을 골랐나.** 4주차에 내가 직접 적어둔 문장이다:
  ...
  > 🔄 **덧붙임 (7/31).** 위 판정을 한 번 더 뒤집어봤다. 처음 검증할 때 나는 1주차 과제(`보고-포맷-변환`)와 4주차 과제(고고버디)를 흔적 OS의 증거로 섞어 쓰고 있었는데, **그 둘은 계보가 다른 별개 제품**이었다. 그래서 전부 빼고 다시 돌렸다.
  > **판정은 안 바뀌었고, 근거 등급은 오히려 올라갔다** — 빠진 자리(1주차 인터뷰 = *말*)를 위 ①②③(= *행동*)이 채웠기 때문이다.
  > 대신 그 위에 세웠던 결론 몇 개는 스스로 철회했다: *"역할을 가로지르는 패턴"*, 임원 보고 슬라이드로의 확장, 두 번째 타깃 사용자군. **증거를 빼고도 결론이 그대로면 의심해야 한다고 생각해서, 문서마다 "뺀 자리를 무엇이 채웠는지"를 명시했다.**
...
- **최종 완성한 것 (지금 어디까지):**
  ...
  **📌 3주에 나눠 하려던 개발이 하루에 끝났다.** 계획은 `P0 ~8/2 · P1 ~8/9 · P2 ~8/16`이었는데 7/31에 전부 배포됐다.
  ...
  **④ 무엇을 안 할지 정한 것** (4주차에 배운 것 — 좁히는 결정이 곧 제품력)
  ...
  - 개발은 여기서 끝. **8/1~8/31은 아무것도 만들지 않고 측정만** 한다
  - 제품 범위를 **오히려 좁혔다** — 임원 보고 슬라이드 확장, 두 번째 타깃 사용자군을 근거 소멸로 잘라냈다. 남은 건 *"글 쓰는 사람을 위한 좁고 깊은 도구"* 하나다
  - 개발이 앞당겨져 **판정일이 9/13 → 8/31로 2주 당겨졌다**

- **🚀 실제 배포 URL:** https://imprint-os-app.vercel.app _(비밀번호 보호 · 개인용)_

- **결과물 (링크·스크린샷):**

  - 기획 문서(JTBD 검증 · 페르소나 · 포지셔닝 · 경쟁조사 · 측정설계)와 P0 코드는 개인 저장소에서 관리한다. **판정을 뒤집은 근거는 위 과제 1에 그대로 옮겨 적었다**
  ...
  **② 리포트 → 초안, 한 번의 탭**
  ...
  | v1 — 목록에서 끝남 (before) | 지금 — `초안 만들기` 링크 (after) |
  |---|---|
...
가장 크게 남은 건 이거다 — **만든 것을 지키려 하면 배우지 못한다.** 이번 주에 한 일의 절반은 지난 4주간 쓴 문서에서 틀린 전제를 걷어내는 일이었고, 그 과정에서 애써 세운 결론 몇 개를 스스로 철회했다. 아깝지 않았다. **틀린 축 위에 잘 쌓는 것보다, 축을 옮기고 다시 쌓는 게 빨랐다.** 실제로 3주 걸릴 줄 알았던 개발이 축을 바로잡고 나니 하루에 끝났다.
