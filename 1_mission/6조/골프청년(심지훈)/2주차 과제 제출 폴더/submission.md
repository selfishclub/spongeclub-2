...
>
> ![관제탑 마인드맵뷰 — 나의 과제에서 뻗어나가는 목표 트리](이미지첨부/관제탑-마인드맵뷰.png)
> *마인드맵 뷰 — 나의 과제 → 회사/개인 → 팀 → 목표 → 할 일이 옆으로 뻗는다. 노드 색=상태, 진행율 %도 함께. "지금 내 일 전체가 어떻게 생겼나"를 한 장으로.*
>
> ![관제탑 오늘 할 일(캘린더) 뷰 — 회사·개인 일정 구분](이미지첨부/관제탑-캘린더뷰.png)
> *오늘 할 일(캘린더) 뷰 — 월 달력에 일정이 🔵 회사 / 🟠 개인으로 색 구분되어 표시된다. 상단 전체·회사·개인 필터, 오늘 날짜 하이라이트, 아래엔 선택한 날의 일정 목록. 텔레그램으로 던진 일정이 여기로 자동 분류돼 꽂힌다.*
>
